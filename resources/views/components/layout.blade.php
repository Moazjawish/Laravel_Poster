...
<div class="min-h-full">
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              <div class="  flex justify-center">
                ...
                <p class="text-white mr-3">{{Auth::user()->first_name}}</p>
                <form action="/logout" method="post">
                    @csrf
                    <x-submit-button  href='/logout'>LOGOUT</x-submit-button>
                </form>
                </div>
                @endauth
                @guest
                <div class="buttons flex justify-between">
                    ...
                    <x-link  href='/signup'>SIGNUP</x-link>
  ...
  <header class="bg-white shadow ">
    <div class=" flex justify-between mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <a href="/posts/create" class="mr-2 bg-gray-800  rounded-md px-3 py-2 text-sm font-medium text-white ">Create Post</a>
    </div>
  </header>
  <main>
